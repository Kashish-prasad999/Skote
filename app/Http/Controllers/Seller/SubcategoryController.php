...
class SubcategoryController extends Controller
{
    public function index()
    {
        ...
        return view('seller.product-category.subcategory.index',['subcategories'=>$subcategories]);
    }
    ...
    public function create($categoryId)
    {
        ...
        return view('seller.product-category.subcategory.create',[ 'categoryId' => $categoryId,   "category" => $category, 'cat'=>$cat ]);
    }
    ...
    public function  store(Request $request, $categoryId)
    {
       // dd($request->all());
        ...
        return redirect()->route('subcategory.list')->with('status','Subcategory has been created!');
    }
    public function withoutcreate()
    {
        return view('seller.product-category.subcategory.without-category');
    }
    ...
    public function edit(Subcategory $subcategory){
        ...
        return view('seller.product-category.subcategory.edit',[
    ...
    public function update(Request $request, Subcategory $subcategory){
        ...
        return redirect()->route('subcategory.list')->with('status','Subcategory updated successfully!!');
    }
    
    public function destroy($subcategoryId){
        $subcategory = Subcategory::find($subcategoryId);
        $subcategory->delete();
        return redirect()->route('subcategory.list')->with('status','Subcategory deleted successfully!!');
    }
}
