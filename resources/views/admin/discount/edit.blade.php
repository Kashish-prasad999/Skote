                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{url('admin/discount/'.$discount->id)}}"  method="post">
                                @csrf
                                @method("PUT")
                                <div class="form-group row mb-4">
                                    <label for="name" class="col-form-label col-lg-2">Discount Percentage</label>
                                    <div class="col-lg-10">
                                        <input id="name" name="name" type="text" class="form-control"  value="{{$discount->percentage}}" autofocus>
                                        @error('name')
