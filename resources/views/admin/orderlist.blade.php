                                ...
                                <tbody>
                                    ...
                                    @foreach($orders as $order)
                                        <tr>
                                            <td>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="customCheck2 {{$order->id}}">
                                                    <label class="custom-control-label" for="customCheck2 {{$order->id}}">&nbsp;</label>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                < @if($order->payment_method == 'COD')
                                                    <i class="far fa-money-bill-alt mr-1 font-size-20 align-top"></i> {{$order->payment_method}}
                                                    @elseif($order->payment_method == 'Card')
                                                    <i class="fab fa-cc-mastercard mr-1 font-size-20 align-top"></i> {{$order->payment_method}}
                                                    @else
                                                    <i class="fab fa-cc-paypal mr-1 font-size-20 align-top"></i> {{$order->payment_method}}
                                                    @endif
                                            </td>
                                            <td>
