                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{url('seller/add')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row mb-4">
                                    <label for="product_name" class="col-form-label col-lg-2">Product Name</label>
                                    <div class="col-lg-10">
                                        <input name="product_name" type="text" class="form-control" value="{{old('product_name')}}" placeholder="Enter Product Name">
                                        @error('product_name')
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="brand" type="text" class="form-control" value="{{old('brand')}}" placeholder="Enter Brand Name">
                                        @error('brand')
                                            <span style="color:red">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="quantity" type="text" class="form-control" value="{{old('quantity')}}" placeholder="Enter Quantity">
                                        @error('quantity')
                                            <span style="color:red">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="price" type="number" class="form-control" value="{{old('price')}}" placeholder="Enter Price">
                                        @error('price')
                                            <span style="color:red">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-lg-10">
                                       <select name="subcategory" class="form-control" id= "subcategoryList">
