    ...
    <header id="page-topbar">
        <div class="navbar-header">
            ...
            <div class="d-flex">
                ...
                @guest
                    <a class="mt-4 ml-1" href="{{route('user.login')}}"><i class="bx bx-user font-size-16 align-middle mr-1"></i>Login</a>    

                @endguest
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        @auth<img class="rounded-circle header-profile-user" src="{{asset('storage/app/public/assets/images/users/avatar-1.jpg')}}"
                            alt="Header Avatar">
